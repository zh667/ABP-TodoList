...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 182e79d1-f813-42ea-998d-1d6d8ca60804
```

> `182e79d1-f813-42ea-998d-1d6d8ca60804` is the password of the certificate, you can change it to any password you want.
