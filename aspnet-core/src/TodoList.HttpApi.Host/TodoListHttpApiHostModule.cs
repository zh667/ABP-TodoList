            ...
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                options.FileSets.ReplaceEmbeddedByPhysical<TodoListDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}TodoList.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<TodoListDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}TodoList.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<TodoListApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}TodoList.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<TodoListApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}TodoList.Application"));
            });
        }
    }
